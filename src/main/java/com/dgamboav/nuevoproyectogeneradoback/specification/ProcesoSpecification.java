...
public class ProcesoSpecification implements Specification<Proceso> {

	private final transient FilterTypeInferer filterTypeInferer;
    private final transient  Map<String, Object> filtros;

    public ProcesoSpecification(Map<String, Object> filtros, FilterTypeInferer filterTypeInferer) {
    ...
    public Predicate toPredicate(Root<Proceso> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        ...
        EntityType<Proceso> entityType = root.getModel();
