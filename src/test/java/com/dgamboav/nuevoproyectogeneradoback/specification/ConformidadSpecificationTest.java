...
class ConformidadSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        ConformidadSpecification specification = new ConformidadSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<Conformidad> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<Conformidad> entityType = mock(EntityType.class);
