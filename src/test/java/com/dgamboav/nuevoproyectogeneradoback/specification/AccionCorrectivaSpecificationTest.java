...
class AccionCorrectivaSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        AccionCorrectivaSpecification specification = new AccionCorrectivaSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<AccionCorrectiva> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<AccionCorrectiva> entityType = mock(EntityType.class);
