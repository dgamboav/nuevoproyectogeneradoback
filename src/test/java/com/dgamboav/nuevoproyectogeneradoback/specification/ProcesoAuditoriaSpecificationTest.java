...
class ProcesoAuditoriaSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        ProcesoAuditoriaSpecification specification = new ProcesoAuditoriaSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<ProcesoAuditoria> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<ProcesoAuditoria> entityType = mock(EntityType.class);
