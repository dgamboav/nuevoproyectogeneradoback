...
class NoConformidadSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        NoConformidadSpecification specification = new NoConformidadSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<NoConformidad> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<NoConformidad> entityType = mock(EntityType.class);
