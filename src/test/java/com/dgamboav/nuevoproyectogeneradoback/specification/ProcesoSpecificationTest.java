...
class ProcesoSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        ProcesoSpecification specification = new ProcesoSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<Proceso> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<Proceso> entityType = mock(EntityType.class);
