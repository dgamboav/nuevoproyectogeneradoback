...
class EmpresaSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        EmpresaSpecification specification = new EmpresaSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<Empresa> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<Empresa> entityType = mock(EntityType.class);
