...
class ProyectoSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        ProyectoSpecification specification = new ProyectoSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<Proyecto> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<Proyecto> entityType = mock(EntityType.class);
