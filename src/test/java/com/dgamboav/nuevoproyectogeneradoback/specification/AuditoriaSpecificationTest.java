...
class AuditoriaSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        AuditoriaSpecification specification = new AuditoriaSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<Auditoria> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<Auditoria> entityType = mock(EntityType.class);
