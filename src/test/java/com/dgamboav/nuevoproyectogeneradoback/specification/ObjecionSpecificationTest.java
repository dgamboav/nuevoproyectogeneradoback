...
class ObjecionSpecificationTest {
    ...
    void testToPredicateConFiltros() {
        ...
        ObjecionSpecification specification = new ObjecionSpecification(filtros, filterTypeInferer);

        // Mockear los objetos necesarios para el toPredicate
        Root<Objecion> root = mock(Root.class);
        CriteriaQuery<?> query = mock(CriteriaQuery.class);
        CriteriaBuilder criteriaBuilder = mock(CriteriaBuilder.class);
        EntityType<Objecion> entityType = mock(EntityType.class);
